...
<head>
    ...
    <script type="text/javascript">
        function search() {
           ...
           var temp = "teacher";
           window.location.href="select.do?courseStartDate= "+courseStartDate+'&temp='+temp+'&courseName='+courseName+'&assessment_Methods='+assessment_Methods+'&curriculumNature='+curriculumNature+'&id='+${teacher.id};
...
<div style=" border-bottom: 1px solid black ; width: 1320px;height: 250px;" >
    <div style="width:1320px;height: 40px;float: left ;margin-top: 20px">
        <div style="border:1px solid black;width: 300px;height: 40px;float: left;margin-left: 50px">
            <div style="height: 40px;width: 100px;text-align: center;line-height: 40px;border-right:1px solid black;float: left;font-family: STHupo  ;color: #728DBA ;font-size: 18px">开课时间:</div>
        ...
        <div style="border:1px solid black;width: 300px;height: 40px;float: left;margin-left: 150px">
            <div style="font-size: 18px;height: 40px;width: 100px;text-align: center;line-height: 40px;border-right:1px solid black;float: left;font-family: STHupo  ;color: #728DBA ">课程名称:</div>
            <div style="float: left;height: 40px;width: 199px;">
    ...
    <div style="width:1320px;height: 40px;float: left;margin-top: 50px">
        <div style="border:1px solid black;width: 300px;height: 40px;float: left;margin-left: 50px">
            <div style="font-size: 18px;height: 40px;width: 100px;text-align: center;line-height: 40px;border-right:1px solid black;float: left;font-family: STHupo  ;color: #728DBA">考查方式:</div>
            <div style="float: left;height: 40px;width: 199px;">
        ...
        <div style="border:1px solid black;width: 300px;height: 40px;float: left;margin-left: 150px">
            <div style="font-size: 18px;height: 40px;width: 100px;text-align: center;line-height: 40px;border-right:1px solid black;float: left;font-family: STHupo  ;color: #728DBA">课程性质:</div>
            <div style="float: left;height: 40px;width: 199px;">
...
　
       ...
       <c:choose >
           <c:when test="${empty teacherDto.courseListDto.commonCourses}">
               <tr>
                   <td>&nbsp;</td>
                   <td>&nbsp;</td>
                   <td>&nbsp;</td>
           ...
           <c:otherwise >
               <c:forEach items="${teacherDto.courseListDto.commonCourses}" var="commonCourses">
                   <tr>
            ...
            <c:choose >
                <c:when test="${empty teacherDto.courseListDto.professionalCourses}">
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                ...
                <c:otherwise >
                    <c:forEach items="${teacherDto.courseListDto.professionalCourses}" var="professionalCourses">
                        <tr>
            ...
            <c:choose >
                <c:when test="${empty teacherDto.courseListDto.laboratoryCourses}">
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                ...
                <c:otherwise >
                    <c:forEach items="${teacherDto.courseListDto.laboratoryCourses}" var="laboratoryCourses">
                        <tr>
