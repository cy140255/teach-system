           ...
           <c:otherwise >
               <c:forEach items="${courseListDto.commonCourses}" var="commonCourses">
                   <tr>
                       ...
                       <td>${commonCourses.testTime}</td>
                       <td>${commonCourses.classRoom}</td>
                       <td>${commonCourses.teacherName}</td>
                   </tr>
                ...
                <c:otherwise >
                    <c:forEach items="${courseListDto.professionalCourses}" var="professionalCourses">
                        <tr>
                            ...
                            <td>${professionalCourses.testTime}</td>
                            <td>${professionalCourses.classRoom}</td>
                            <td>${professionalCourses.teacherName}</td>
                        </tr>
                ...
                <c:otherwise >
                    <c:forEach items="${courseListDto.laboratoryCourses}" var="laboratoryCourses">
                        <tr>
                            ...
                            <td><fmt:formatDate value="${laboratoryCourses.testTime}" pattern = "yyyy-MM-dd HH:mm:ss"/></td>
                            <td>${laboratoryCourses.classRoom}</td>
                            <td>${laboratoryCourses.teacherName}</td>
                        </tr>
