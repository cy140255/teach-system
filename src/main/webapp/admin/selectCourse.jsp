...
<head>
    ...
    <script type="text/javascript">
        function search() {
           ...
           var temp = "admin";
           window.location.href="select.do?courseStartDate= "+courseStartDate+'&temp='+temp+'&courseName='+courseName+'&assessment_Methods='+assessment_Methods+'&curriculumNature='+curriculumNature;
